...
class integral_welcome {
	...
	public function integral_welcome_admin_notice() {
		...
		?>
			<div class="notice notice-info">
                ...
                <p><?php echo sprintf( esc_html__( 'Begin by visiting our %swelcome page%s', 'integral' ), '<a href="' . esc_url( admin_url( 'themes.php?page=integral-welcome' ) ) . '">', '</a>' ); ?> <?php _e( 'to setup your theme and start customizing your site.', 'integral' ); ?></p>
                <p><?php _e( 'IMPORTANT: Make sure you complete the theme setup in order to take advantage of everything Integral has to offer. It is super easy and takes less than 1 minute.', 'integral' ); ?></p>
				<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=integral-welcome' ) ); ?>" class="button button-primary" style="text-decoration: none;"><?php _e( 'Get Started with Integral', 'integral' ); ?></a> <?php echo $dismiss_url ?> <a target="_blank" href="<?php echo esc_url('https://www.themely.com/themes/integral/'); ?>" class="button button-primary" style="text-decoration: none;"><?php _e( 'Upgrade to Integral PRO!', 'integral' ); ?></a></p>
				<p></p>
			</div>
		<?php
	}
	...
	public function integral_welcome_screen() {
        ...
        <div class="wrap about-wrap theme-welcome">
            <h1><?php esc_html_e('Welcome to Integral - Version 1.1.9', 'integral'); ?></h1>
            ...
            <div class="info-tab-content">
                <div class="left">
                    <div>
                    	<p>Follow the steps below to setup Integral and begin customizing your website.</p>
                        ...
                        <ol>
                            ...
                            <li><?php esc_html_e('Install', 'integral'); ?> <a target="_blank" href="<?php echo esc_url('https://wordpress.org/plugins/theme-demo-import/'); ?>">Theme Demo Import</a> <?php esc_html_e('plugin', 'integral'); ?></li>
                        </ol>
                        <p>
                    ...
                    <div>
                        ...
                        <br /><?php esc_html_e('Live demo:', 'integral'); ?> <a target="_blank" href="<?php echo esc_url('http://demo.themely.com/integral/'); ?>">http://demo.themely.com/integral/</a><br /><i><?php esc_html_e('(Make sure you have installed the Theme Demo Import Plugin before)', 'integral'); ?></i></p>
                    ...
                    <div>
                        <h3><?php esc_html_e('Step 4 - Customize Your Website', 'integral'); ?></h3>
